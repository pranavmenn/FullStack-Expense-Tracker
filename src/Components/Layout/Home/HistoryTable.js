...
sort = (field) =>{
  this.setState({
    expenses: this.state.expenses.sort((a,b)=> a[field]<b[field]?-1:1)
  })
  ...
  */}
    ...
    return(
      ...
      <div className="heading"><h3>Expense History for {name} </h3></div>
            ...
            <TableWithSpinner sort={this.sort} expenses ={this.state.expenses} deleteHandler={this.deleteHandler} isLoading={this.state.loading} />
